...
alias pandoc="pandoc -f markdown-implicit_figures -t pdf \"$@\" > \"$@\""
...
# alias cpdir="cd ~/documents/Code/comp-prog/code_space/c++"
# alias edit="open -a MacVim.app $1"
# alias gon="cd ~/documents/berkeley/Academics/workspace"
# alias ls="exa -l -h"
# alias goc="ssh hive3"
